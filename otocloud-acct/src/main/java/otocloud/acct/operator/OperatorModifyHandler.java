...
public class OperatorModifyHandler extends OtoCloudEventHandlerImpl<JsonObject> {

	public static final String OP_MODIFY = "modify";
	
	public static final String USER_REGISTER = "user-management.users.put";
	 ...
	 * @param componentImpl
	 */
	public OperatorModifyHandler(OtoCloudComponentImpl componentImpl) {
		super(componentImpl);
	}
		...
		componentImpl.getEventBus().send(address,
				userRegInfo, regUserRet->{
					if(regUserRet.succeeded()){
						...
						userRegInfo.put("id", userInfo.getString("userOpenId"));						
						ret.complete();											
					}else{						
